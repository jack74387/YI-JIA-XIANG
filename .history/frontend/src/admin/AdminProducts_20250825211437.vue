                ...
                <div class="md:col-span-2">
                  ...
                  <div class="bg-gray-50 p-4 rounded-md space-y-3">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                      ...
                      <div>
                        <label class="block text-xs font-medium text-gray-600 mb-1">飽和脂肪</label>
                        <input 
                          v-model="form.nutrition_info.saturated_fat" 
                          type="text" 
                          placeholder="5公克"
                          class="w-full px-2 py-1 text-sm border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-amber-500"
                        />
                      ...
                      <div>
                        <label class="block text-xs font-medium text-gray-600 mb-1">反式脂肪</label>
                        <input 
                          v-model="form.nutrition_info.trans_fat" 
                          type="text" 
                          placeholder="0公克"
                          class="w-full px-2 py-1 text-sm border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-amber-500"
                        />
