      ...
      <div class="container">
        ...
        <div class="product-grid">
            ...
            <div class="product-card" :class="`product-${index + 1}`">
              ...
              <div class="product-info">
                ...
                <div class="product-price">
                  <span class="current-price">NT$ {{ product.price_large?.toLocaleString() || 'N/A' }}</span>
                  <span v-if="product.price_small && product.price_small !== product.price_large" class="original-price">
                    NT$ {{ product.price_small?.toLocaleString() }}
                  </span>
                </div>
          ...
          <div v-if="!loading && featuredProducts.length === 0" class="col-span-full text-center py-20">
            <p class="text-gray-500 text-lg">暫無精選商品</p>
          </div>
        </div>
