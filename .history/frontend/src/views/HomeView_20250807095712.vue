              ...
              <div class="product-display" v-if="featuredProducts.length > 0">
                <div class="main-product">
                  ...
                  <div class="product-info-overlay">
                    ...
                    <div class="product-price">NT$ {{ formatPrice(featuredProducts[selectedProductIndex]?.price_large) }}</div>
                  </div>
                </div>
                  ...
                  <div class="product-options">
                    ...
                    >
                      ...
                      <div class="option-info">
                        ...
                        <div class="option-price">NT$ {{ formatPrice(product.price_large) }}</div>
                      </div>
                    </div>
                  </div>
                </div>
