...
/* Hero Section */
.hero-bg {
  background: linear-gradient(135deg, #d9a68c 0%, #f0d1c2 100%);
  min-height: 80vh;
  display: flex;
  align-items: center;
...
.cta-button.primary {
  background: linear-gradient(90deg, #f4c2a3, #d1774e);
  color: white;
  box-shadow: 0 8px 24px rgba(0, 0, 0, 0.15);
}

.cta-button.primary:hover {
  box-shadow: 0 12px 32px rgba(0, 0, 0, 0.25), 0 0 8px rgba(244, 194, 163, 0.5);
}
