    ...
    <div class="featured-products-section">
      <div class="container">
        ...
        <div class="product-grid">
          <!-- 商品1: 海苔芝麻豬肉鬆 -->
          <router-link :to="'/products/2'" class="product-card-link">
            <div class="product-card product-1">
              <div class="product-image">
                <img src="https://res.cloudinary.com/daeb3goxf/image/upload/v1754376263/yijiaxiang/products/zibx7lhjapg6g7bqgbni.png" alt="海苔芝麻豬肉鬆" class="w-full h-48 object-cover rounded-t-lg mx-auto" />
                <div class="product-badge">熱銷</div>
                <div class="product-overlay">
                  <div class="quick-view-btn">快速查看</div>
                </div>
              </div>
              <div class="product-info">
                <div class="product-name">海苔芝麻豬肉鬆</div>
                <div class="product-desc">香脆海苔與芝麻的完美結合</div>
                <div class="product-price">
                  <span class="current-price">NT$ 340</span>
                  <span class="original-price">NT$ 370</span>
                </div>
          ...
          <!-- 商品2: 五香豬肉條 -->
          <router-link :to="'/products/4'" class="product-card-link">
            <div class="product-card product-2">
              <div class="product-image">
                <img src="https://res.cloudinary.com/daeb3goxf/image/upload/v1754376263/yijiaxiang/products/gfwp01goehxbycqqql7k.png" alt="五香豬肉條" class="w-full h-48 object-cover rounded-t-lg mx-auto" />
                <div class="product-badge">熱銷</div>
                <div class="product-overlay">
                  <div class="quick-view-btn">快速查看</div>
                </div>
              ...
              <div class="product-info">
                <div class="product-name">五香豬肉條</div>
                <div class="product-desc">傳統工法製作，香氣十足</div>
                <div class="product-price">
                  <span class="current-price">NT$ 440</span>
                  <span class="original-price">NT$ 470</span>
                </div>
                <div class="product-rating">
                  <div class="stars">★★★★★</div>
          ...
          <!-- 商品3: 五香豬肉絲 -->
          <router-link :to="'/products/5'" class="product-card-link">
            <div class="product-card product-3">
              <div class="product-image">
                <img src="https://res.cloudinary.com/daeb3goxf/image/upload/v1754376263/yijiaxiang/products/zibx7lhjapg6g7bqgbni.png" alt="五香豬肉絲" class="w-full h-48 object-cover rounded-t-lg mx-auto" />
                <div class="product-badge">熱銷</div>
                <div class="product-overlay">
                  <div class="quick-view-btn">快速查看</div>
                </div>
              ...
              <div class="product-info">
                <div class="product-name">五香豬肉絲</div>
                <div class="product-desc">嚴選豬肉，精心調製五香配方</div>
                <div class="product-price">
                  <span class="current-price">NT$ 440</span>
                  <span class="original-price">NT$ 470</span>
                </div>
          ...
          <!-- 商品4: 蜜汁原味豬肉乾 -->
          <router-link :to="'/products/6'" class="product-card-link">
            <div class="product-card product-4">
              <div class="product-image">
                <img src="https://res.cloudinary.com/daeb3goxf/image/upload/v1754376263/yijiaxiang/products/zibx7lhjapg6g7bqgbni.png" alt="蜜汁原味豬肉乾" class="w-full h-48 object-cover rounded-t-lg mx-auto" />
                <div class="product-badge">熱銷</div>
                <div class="product-overlay">
                  <div class="quick-view-btn">快速查看</div>
                </div>
              ...
              <div class="product-info">
                <div class="product-name">蜜汁原味豬肉乾</div>
                <div class="product-desc">甜中帶鹹，口感紮實有嚼勁</div>
                <div class="product-price">
                  <span class="current-price">NT$ 420</span>
                  <span class="original-price">NT$ 450</span>
                </div>
                <div class="product-rating">
                  <div class="stars">★★★★★</div>
                  <span class="rating-text">(4.9)</span>
...
.hero-bg {
  position: relative;
  background: linear-gradient(135deg, #be633f 0%, #b46f53 50%, #d48f6d 100%);
  min-height: 80vh;
  display: flex;
  align-items: center;
