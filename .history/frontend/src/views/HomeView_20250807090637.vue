...
.hero-bg {
  position: relative;
  background: 
    radial-gradient(ellipse at 30% 50%, rgba(240, 180, 140, 0.6) 0%, transparent 50%),
    radial-gradient(ellipse at 70% 30%, rgba(209, 119, 78, 0.5) 0%, transparent 40%),
    linear-gradient(135deg, 
      rgba(209, 119, 78, 0.85) 0%, 
      rgba(200, 126, 90, 0.75) 40%, 
      rgba(224, 162, 126, 0.65) 100%
    );
  min-height: 60vh;
  display: flex;
  align-items: center;
  ...
  margin-bottom: 20px;
  box-shadow: 
    0 4px 20px rgba(209, 119, 78, 0.15),
...
@keyframes gentleFloat {
  ...
  66% { 
    transform: translateY(-12px) translateX(-3px) scale(0.9); 
    opacity: 0.8;
  }
}
...
@media (max-width: 768px) {
  .hero-bg {
    ...
    margin-bottom: 16px;
    box-shadow: 
      0 4px 16px rgba(209, 119, 78, 0.12),
