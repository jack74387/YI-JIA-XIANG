        ...
        <table class="w-full mb-8 border-separate border-spacing-y-3 cart-table-desktop">
          ...
          <tbody>
            <tr v-for="item in cart.items" :key="item.id" class="bg-white rounded-lg shadow-sm">
              <td class="py-2">
                <img :src="getImageUrl(item.product?.primary_image?.image_path) || '/images/placeholder.jpg'" alt="商品圖" class="w-16 h-16 object-cover rounded" />
              </td>
        ...
        <div class="cart-list">
          <div v-for="item in cart.items" :key="item.id" class="cart-item-card">
            <div class="flex gap-3 items-center">
              <img :src="getImageUrl(item.product?.primary_image?.image_path) || '/images/placeholder.jpg'" alt="商品圖" class="cart-item-img" />
              <div class="flex-1">
