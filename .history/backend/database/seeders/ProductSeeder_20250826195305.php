    ...
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                ...
                'price_small' => 350,
                'unit' => '包',
                'description' => '這不僅僅是一份牛肉乾，而是一場舌尖上的極致饗宴。我們吹毛求疵地只選用進口頂級牛隻的後腿心部位，此處的牛肉油脂含量低、肉質纖維清晰，是製作肉乾的黃金首選。
                                    老師傅以傳承數十年的獨門醬汁為基底，加入現磨的粗粒黑胡椒與多種天然香料，將厚切的牛肉條浸泡長達48小時，確保每一絲纖維都吸飽了醇厚的風味。接著，採用恆溫慢火的細膩烘烤工法，歷經數小時的淬鍊，不僅逼出多餘的油脂，更將肉汁的精華牢牢鎖在其中。
                                    撕開時，濃郁的黑胡椒辛香撲鼻而來，入口的瞬間，先是扎實卻不乾柴的嚼勁，咀嚼之間，牛肉本身的甘醇與醬汁的醍醐味完美釋放，而黑胡椒的微辣尾韻則在口中繚繞不散，層次豐富，令人回味無窮。無論是獨自享受的靜謐時光，或是與摯友舉杯暢談，這份黑胡椒牛肉乾都是您品味生活、犒賞自己的不二之選。',
                ...
                'nutrition_info' => json_encode([
                    ...
                    'saturated_fat' => '5公克',
                    'trans_fat' => '0公克',
                    'carbohydrates' => '37.3公克',
                    'sodium' => '1173毫克',
                    'sugar' => '27公克'
                ]),
                'ingredients' => '牛肉、糖、醬油、黑胡椒',
                'allergens' => '本產品含有大豆製品',
                'origin' => '台灣',
                'package_info' => json_encode([
                    ['name' => '600g 大包裝', 'description' => '適合家庭分享'],
            ...
            [
                ...
                'price_small' => 360,
                'unit' => '包',
                'description' => '乘載著無數人童年回憶的經典滋味，獻給每一位熱愛海洋鮮味的您。我們堅持只選用遠洋捕撈、肉質特別肥厚飽滿的A級魷魚，在捕撈上岸的第一時間急速冷凍，只為鎖住那份來自大海最初始的鮮甜。
                                    每一片魷魚片都經過繁複的傳統工序，細心去除內臟與薄膜，只留下最精華、最彈牙的部位。經過老師傅的巧手調味後，以獨特的直火烘烤技術，讓魷魚的鮮味在高溫下瞬間昇華，表面烤出誘人垂涎的金黃焦糖色澤，散發出無法抗拒的迷人香氣。
                                    入口的口感厚實而Q彈，帶著微微的韌性，咀嚼時能感受到每一寸海洋纖維在齒間彈跳的樂趣。口中先是迎來一股溫潤的鹹香，隨後魷魚本身的清甜甘醇滿溢開來，濃郁卻不膩口。這不僅是看電視、郊遊旅行時的最佳夥伴，更是能穿越時光，帶您重溫美好記憶的懷舊美味。',
