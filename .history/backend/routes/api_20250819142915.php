...
Route::prefix('v1')->group(function () {
    // 代理路由 - 透過 Laravel 代理到內網 API
    Route::get('/proxy/products', [ProductProxyController::class, 'index']);
    Route::get('/proxy/products/{id}', [ProductProxyController::class, 'show']);
    Route::get('/proxy/products/{id}/recommendations', [ProductProxyController::class, 'getRecommendations']);
    Route::get('/proxy/categories', [CategoryController::class, 'index']);
    Route::get('/proxy/categories/{id}', [CategoryController::class, 'show']);
    
    // 公開路由 - 不需要認證（保留原有的，以防有直接使用）
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::middleware('auth:sanctum')->group(function () {
            ...
            Route::get('/admin/settings/hero-bg', [\App\Http\Controllers\Admin\SettingController::class, 'getHeroBgImage']);
            Route::post('/admin/settings/hero-bg', [\App\Http\Controllers\Admin\SettingController::class, 'uploadHeroBgImage']);
            Route::delete('/admin/settings/hero-bg', [\App\Http\Controllers\Admin\SettingController::class, 'deleteHeroBgImage']);
    ...
    Route::get('/settings/hero-bg', [\App\Http\Controllers\Admin\SettingController::class, 'getHeroBgImage']);
